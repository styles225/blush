	...
	<nav class="header-main-nav">
		...
		<div class="header-content">
			<div class="header-left-menu">
				<ul class="header-left-menu-options">
					{{#if showLanguagesOrCurrencies}}
					<li class="header-left-menu-settings">
						<a href="#" class="header-left-menu-settings-link" data-toggle="dropdown" title="{{translate 'Settings'}}">
